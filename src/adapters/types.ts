...
export interface HarnessAdapter { name: HarnessName; configurationPath: string; nativeEvents: string[]; translate(input: unknown, nativeEvent?: string): GauntletEvent }
