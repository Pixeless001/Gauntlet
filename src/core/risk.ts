...
export interface RiskAssessment { level: TaskRisk; reasons: string[] }

export function assessRisk(contract: TaskContract, changes: FileDelta[] = []): RiskAssessment {
  ...
  if (reasons.length) return { level: "elevated", reasons };
