...
export const ARCHITECTURE_AUDIT: readonly ArchitectureAuditItem[] = [
  ...
  partial("substrate", "native substrate conformance", "The shipping engine has no LangGraph dependency, exposes only the narrow execution boundary, and is selected after a disposable external LangGraph checkpoint probe.", ["src/execution/native-engine.ts#NativeExecutionEngine", "src/measure/substrate.ts#LANGGRAPH_PROBE", "src/measure/substrate.ts#SUBSTRATE_COMPARISON"], ["test/native-engine.test.ts#native engine checkpoints", "test/evals.test.ts#substrate comparison covers"], "The verified temporary probe directory remains because host policy blocked its removal."),
