...
export const ARCHITECTURE_AUDIT: readonly ArchitectureAuditItem[] = [
  ...
  done("substrate", "native substrate conformance", "The shipping engine has no LangGraph dependency and exposes only the narrow execution boundary.", ["src/execution/native-engine.ts#NativeExecutionEngine", "src/measure/substrate.ts#SUBSTRATE_COMPARISON"], ["test/native-engine.test.ts#native engine checkpoints", "test/evals.test.ts#substrate comparison covers"]),
