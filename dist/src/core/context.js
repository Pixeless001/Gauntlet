import { selectContext } from "../repo/context.js";
import { MAX_CONTEXT_TOKENS } from "./policy.js";
import { loadLessons } from "../repo/lessons.js";
import { fuseProof } from "../context/proof-views.js";
export async function createContextPacket(cwd, contract, conventions = [], index, execution) {
